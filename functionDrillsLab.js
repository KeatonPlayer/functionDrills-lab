...
//CODE HERE
let jsNinja =() => console.log('I am a js ninja')
...
//CODE HERE
let compareNums =(num1,num2) => {if (num1<num2){
console.log(num2)
}
else if(num1>num2){
  console.log(num1)
...
let logging = console.log(add('1','6'))
...
else {console.log(`Cool name mr ${name}`)}
}

let nameGreeting = nameCheck('Sanjay and Craig')
...
function faveColorFinder(color){
 ...
 let color3 =  'black'
 if(color === color1){
   return 'People with red hair have no soul'
 }
 else if(color === color2){
   return 'The friendly green giant it green and hes made out of spinach so there is that too'
 }
 else if(color === color3) {
   return 'So you like black licorice huh,..... so do I'
}
else {return 'Could not have picked a cooler color'}
}
...
for(let i=0; i<array.length; i++){
  if(array[i]>100){ answers.push(array[i])
   } else if (array[i]<100){
     answers.push('small')
   }
 }
